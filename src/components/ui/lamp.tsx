    ...
    <section className="w-full min-h-screen flex flex-col items-center justify-center">
      <LampContainer>
        <motion.h1
          ...
          className="mt-8 bg-gradient-to-br from-white to-slate-300 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-6xl lg:text-7xl"
        >
        ...
        <motion.p
          ...
          className="mt-4 text-slate-300 text-center text-lg md:text-xl max-w-prose mx-auto px-4"
        >
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <a href="#contact" className="btn btn-primary text-white rounded-full font-medium hover:bg-cyan-600 transition-colors">
            Get Started
          </a>
        </motion.div>
      </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center overflow-hidden w-full px-4",
        className
      )}
    >
      ...
      <div className="relative z-50 flex flex-col items-center px-5 mt-[-20rem] md:mt-[-15rem]">
        {children}
      </div>
    </div>
  );
