...
export function LampDemo() {
  return (
    <section className="h-screen w-full relative flex flex-col items-center justify-center overflow-hidden bg-slate-950">
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
        <LampContainer>
          <motion.h1
          ...
          <motion.p
            ...
            className="mt-4 text-slate-300 text-center text-lg md:text-xl max-w-2xl mx-auto px-4"
          >
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <a href="#contact" className="inline-block px-8 py-3 btn btn-primary text-white rounded-full font-medium hover:bg-cyan-600 transition-colors">
              Get Started
            </a>
          </motion.div>
        </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full flex-col items-center justify-center overflow-hidden rounded-md z-0",
        className
      )}
    >
